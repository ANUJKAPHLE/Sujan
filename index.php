...
<div class="container bg-light shadow-md rounded px-4 py-4">
    <div class="row align-items-center border-bottom-4">
        <!-- Bus Search Start -->
        <div class="col-sm-4">
            <h2 class="text-4 mb-3">Bus E-Booking System</h2></br>
                ...
                <div class="form-row">
                    <div class="col-lg-6 form-group">
                        <select class="form-control" name="from">
                            ...
                            <option value="Kathmandu">Kathamndu</option>
                ...
                <div class="row">
                    <div class="col-sm-6 col-md-3">
                        <div class="featured-box text-center">
                            ...
                            <p>Moving your real time to a much more secured place.</p>
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-3">
                        <div class="featured-box text-center">
                    ...
                    <div class="col-sm-6 col-md-3">
                        <div class="featured-box text-center">
                            ...
                            <h4>Refer &amp; Earn</h4>
                            <p>Invite a friend to sign up and earn up to rs 1000.</p>
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-3">
                        <div class="featured-box text-center">
